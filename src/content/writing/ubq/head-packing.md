...
The name derives from [BBQ, the Block-based Bounded Queue][bbq] presented at USENIX ATC 2022. UBQ's implementation begins with the algorithm powering Crossbeam's `SegQueue` and changes how its queue positions are represented.
